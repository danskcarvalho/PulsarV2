...
{
    private async Task<PaginatedListDTO<UsuarioListadoDTO>> FindUsuariosBloqueadosByCursor(string strCursor, int limit)
    {
        limit = limit.Limit();
    ...
    private async Task<PaginatedListDTO<UsuarioListadoDTO>> FindUsuariosBloqueadosWithoutCursor(string? filtro, string dominioId, int limit)
    {
        limit = limit.Limit();
