...
public class ValidarEstabelecimentosRedesDomainEventHandler : IdentityDomainEventHandler<GrupoModificadoDomainEvent>
{
    public ValidarEstabelecimentosRedesDomainEventHandler(IdentityDomainEventHandlerContext<GrupoModificadoDomainEvent> ctx) : base(ctx)
    {
    }
