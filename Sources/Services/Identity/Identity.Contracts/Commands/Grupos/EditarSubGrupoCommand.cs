...
public class EditarSubGrupoCommand : IRequest<CommandResult>
{
    [SwaggerExclude]
...
public class EditarSubGrupoCommandValidator : AbstractValidator<EditarSubGrupoCommand>
{
    public EditarSubGrupoCommandValidator()
    {
        RuleFor(x => x.Nome)
