...
public class AdicionarUsuariosSubGrupoCommand : IRequest<CommandResult>
{
    [SwaggerExclude]
...
public class AdicionarUsuariosSubGrupoCommandValidator : AbstractValidator<AdicionarUsuariosSubGrupoCommand>
{
