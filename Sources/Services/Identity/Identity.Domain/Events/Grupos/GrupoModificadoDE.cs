...
public class GrupoModificadoDE : INotification
{
    ...
    public GrupoModificadoDE(ObjectId usuarioLogadoId, ObjectId dominioId, ObjectId grupoId, string nome, AuditInfo auditInfo, List<SubGrupo> subGruposModificados, List<SubGrupo> subGruposAdicionados, List<SubGrupo> subGruposRemovidos, ChangeEvent modificacao, long version)
    {
