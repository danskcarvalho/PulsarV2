...
public class UsuariosAdicionadosOuRemovidosEmGrupoDomainEvent : INotification
{
    ...
    public UsuariosAdicionadosOuRemovidosEmGrupoDomainEvent(ObjectId usuarioLogadoId, ObjectId grupoId, ObjectId subGrupoId, ObjectId dominioId, bool remocao, List<ObjectId> usuarioIds)
    {
