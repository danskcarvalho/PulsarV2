...
public class ConviteAceitoDomainEvent : INotification
{
    ...
    public ConviteAceitoDomainEvent(ObjectId conviteId, ObjectId usuarioId, string primeiroNome, string? sobrenome, string nomeUsuario, string senha, string email, ObjectId? criadoPorUsuarioId)
    {
        ConviteId = conviteId;
        UsuarioId = usuarioId;
